...
public class ListaPlanillasXUsuarioFinalizadasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_planillas_xusuario_finalizada);
...
//        se reflejen en la aplicacion
    ...
    public void onActionPreparacion(View view) {
